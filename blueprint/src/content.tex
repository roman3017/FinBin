...
verified in Lean~4 with Mathlib~\cite{bacik2026finbin}. Every unary function $f \colon X \to X$ embeds into a
...
graph of $f$, is given in \cite{bacik2025linear}.
...
\bibitem{bacik2026finbin}
R.~Bacik.
FinBin.
\url{https://github.com/roman3017/FinBin}, 2026.
