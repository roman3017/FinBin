...
verified in Lean~4 with Mathlib. Every unary function $f \colon X \to X$ embeds into a
...
\begin{definition}[Kronecker delta]\label{def:kron}\lean{Finbin.kronecker_delta}\leanok
